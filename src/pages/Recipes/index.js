                        ...
                        <div id="carouselExampleIndicators" className="carousel slide pt-3 carousel_size" data-bs-ride="carousel">
                            ...
                            <div className="carousel-inner ">
                                <div className="carousel-item active">
                                    <img src={pancakeImg} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={sanwanImg} className="d-block w-100" alt="..." />
                                </div>
                                <div className="carousel-item">
                                    <img src={eggImg} className="d-block w-100" alt="..." />
                                </div>
                            </div>
            ...
            <section>
                <div className="j_container mt-5 pb-5">
                    <div className="glass menu">
                        ...
                        <div className="d-md-flex w-75 m-auto">
                            <div className="w-100 m-auto border-1 mt-3 mb-3 pb-3 pb-md-0  row justify-content-center">
                            ...
                            <div className="col-3 col-md-1 rounded-pill d-flex align-items-center justify-content-center btn_bgc_color m-auto text-center text-white mb-3 next">Next...</div>
                        </div>
                    </div>
                </div>
            </section>
